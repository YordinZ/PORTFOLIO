...
const Hero = () => {
  ...
  // ✅ aquí (fuera del useEffect), para poder usarlo en el JSX
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24">
          <div className="relative group">
            ...
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-to-br from-cyan-400 to-fuchsia-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-white" fill="none">
          ...
          <div className="text-center lg:text-left space-y-6 max-w-2xl">
            <div className="space-y-2">
              <h3 className="text-2xl md:text-3xl font-light text-white/70 animate-fade-in">Hi, I'm</h3>
              <h1 className="text-5xl md:text-7xl font-bold text-white animate-fade-in-up">Yordin Herrera B.</h1>
            ...
            <div className="flex gap-6 justify-center lg:justify-start">
              <a href="https://github.com/YordinZ" target="_blank" rel="noopener noreferrer" className="group">
              ...
              <a href="https://www.linkedin.com/in/yordinxherrera/" target="_blank" rel="noopener noreferrer" className="group">
                <div className="w-14 h-14 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center hover:bg-gradient-to-r hover:from-cyan-500 hover:to-fuchsia-600 hover:border-transparent hover:scale-110 transition-all">
